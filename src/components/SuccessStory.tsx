    ...
    <section id="success-story" className="py-20 lg:py-24 bg-charcoal text-white relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-white mb-4 leading-tight text-left">
                    {timelineData[activeTab].title}
                  </h3>
                  <p className="text-xs sm:text-sm text-white/70 leading-relaxed font-sans font-normal text-left">
          ...
          <div className="grid grid-cols-3 gap-2 w-full pt-8 border-t border-white/5 text-center">
            <div>
