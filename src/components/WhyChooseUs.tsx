      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:grid grid-cols-3 gap-6 relative z-10">
          {reasons.map((reason, idx) => (
            <div
              key={idx}
              className="bg-white rounded-[2rem_0.5rem_2rem_0.5rem] p-6 border-2 border-[#E55928]/45 shadow-lg shadow-[#E55928]/5 flex flex-col items-start relative overflow-hidden transition-all duration-500 hover:border-[#E55928]/85 hover:shadow-2xl hover:shadow-[#E55928]/10 hover:-translate-y-1.5 group cursor-pointer"
            >
        ...
        <div className="block lg:hidden mt-8">
          ...
          <div className="relative overflow-hidden py-4 w-screen left-[50%] right-[50%] -ml-[50vw] -mr-[50vw]">
            <div
              ref={mobileScrollRef}
            ...
            >
              {[...reasons, ...reasons].map((reason, idx) => (
                <div
                  key={`marquee-${idx}`}
                  className="w-[280px] shrink-0 bg-white rounded-[2rem_0.5rem_2rem_0.5rem] p-6 border-2 border-[#E55928]/45 shadow-lg shadow-[#E55928]/5 flex flex-col items-start relative overflow-hidden transition-all duration-500 group hover:border-[#E55928]/85"
                >
