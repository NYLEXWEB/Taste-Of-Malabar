...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-10 lg:py-14 bg-cream-dark relative overflow-hidden">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h4 className="font-serif text-xs font-bold text-neutral-500 uppercase tracking-wider mb-1">Call Booking Team</h4>
                  <p className="text-base font-bold text-charcoal tracking-wide">+91 6238 599 197</p>
                  <p className="text-[10px] text-neutral-500 mt-0.5">Available daily: 9:00 AM - 9:00 PM</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <h4 className="font-serif text-xs font-bold text-neutral-500 uppercase tracking-wider mb-1">WhatsApp Chat</h4>
                  <p className="text-base font-bold text-charcoal tracking-wide">+91 6238 599 197</p>
              ...
              >
                ...
                <div>
                  <h4 className="font-serif text-xs font-bold text-neutral-500 uppercase tracking-wider mb-1">Email Inquiries</h4>
                  <p className="text-sm font-bold text-charcoal">tasteofmalabarkannur@gmail.com</p>
                  <p className="text-[10px] text-neutral-500 mt-0.5">Get proposal within 24 hours</p>
                </div>
              </a>
              ...
              <div className="flex items-start gap-4 p-5 rounded-2xl bg-white border border-neutral-200/80">
                ...
                <div>
                  <h4 className="font-serif text-xs font-bold text-neutral-500 uppercase tracking-wider mb-1">Office Address</h4>
                  <p className="text-sm font-bold text-charcoal">Manjapalam, Kannur, Kerala - 670001</p>
                  <p className="text-[10px] text-neutral-500 mt-0.5">Corporate & Booking Office</p>
                </div>
              </div>
            </div>
          </motion.div>
              ...
              {!isSubmitted ? (
                ...
                >
                  <div className="text-center sm:text-left mb-6">
                    ...
                    <p className="text-xs text-neutral-500 mt-1">Fill out the details below and we will contact you shortly.</p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {/* Name */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="name" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Full Name *</label>
                      <input
                        type="text"
                        id="name"
                        name="name"
                    ...
                    {/* Phone */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="phone" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Phone Number *</label>
                      <input
                        type="tel"
                        id="phone"
                        name="phone"
                    ...
                    {/* Event Type */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="eventType" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Event Type *</label>
                    ...
                    {/* Guest Count */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="guestCount" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Guest Count *</label>
                      <div className="relative">
                        <input
                          type="number"
                          id="guestCount"
                    ...
                    {/* Event Date */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="eventDate" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Event Date *</label>
                      <div className="relative">
                        <input
                          type="date"
                          id="eventDate"
                    ...
                    {/* Location */}
                    <div className="flex flex-col space-y-1.5">
                      <label htmlFor="location" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Event Location *</label>
                      <div className="relative">
                        <input
                          type="text"
                          id="location"
                  ...
                  {/* Message */}
                  <div className="flex flex-col space-y-1.5">
                    <label htmlFor="message" className="text-xs font-bold uppercase tracking-wider text-neutral-600">Message & Special Requests</label>
                    <textarea
                      id="message"
                      name="message"
                      rows={4}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-650 mt-2 max-w-sm mx-auto">
