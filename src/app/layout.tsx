...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Corporate Catering Services Kannur",
    "Birthday Party Catering Kannur",
    "Outdoor Catering Services Kerala",
    "Stage Decoration Kannur",
    "Wedding Stage Decoration Kerala",
    "Wedding Planner Kannur",
    "Wedding Organizers Kannur",
    "Event Planners Kannur",
    "Engagement Event Management Kannur",
    ...
    "Affordable Catering Services Kannur",
