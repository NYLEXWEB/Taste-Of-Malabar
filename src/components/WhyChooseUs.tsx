...
export default function WhyChooseUs() {
  ...
  return (
    <section className="py-24 lg:py-36 bg-[#121212] relative overflow-hidden">
      {/* Decorative vectors */}
      ...
      <svg 
        className="absolute left-4 top-1/2 -translate-y-1/2 w-[220px] h-[380px] opacity-[0.03] pointer-events-none text-gold select-none" 
        viewBox="0 0 100 200" 
        fill="none" 
        stroke="currentColor" 
        strokeWidth="0.5"
        ...
        >
          {reasons.map((reason, idx) => (
            <motion.div
              ...
              className="bg-[#1A1A1A] p-6 rounded-2xl border border-white/5 shadow-sm hover:border-gold/30 transition-all duration-300 flex flex-col items-start"
            >
              {/* Icon */}
